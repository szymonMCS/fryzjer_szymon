...
class Settings(BaseSettings):
    ...
    RAG_LLM_MODEL: str = Field(default="gpt-4.1-nano", description="Model LLM do generowania odpowiedzi RAG")
    RAG_EMBEDDING_MODEL: str = Field(default="text-embedding-3-large", description="Model do generowania embeddingów")
